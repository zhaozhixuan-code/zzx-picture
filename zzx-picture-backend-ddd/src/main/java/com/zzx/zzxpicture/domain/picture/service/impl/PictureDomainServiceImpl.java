package com.zzx.zzxpicture.domain.picture.service.impl;
...
import com.zzx.zzxpicture.infrastructure.api.aliyunai.AliyunAiApi;
import com.zzx.zzxpicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.zzx.zzxpicture.infrastructure.utils.ColorSimilarUtils;
import com.zzx.zzxpicture.infrastructure.manager.upload.FilePictureUpload;
import com.zzx.zzxpicture.infrastructure.manager.upload.PictureUploadTemplate;
import com.zzx.zzxpicture.infrastructure.manager.upload.UrlPictureUpload;
...
/*             if (!loginUser.getId().equals(space.getUserId())) {
        ...
        transactionTemplate.execute(status -> {
            ...
            if (pictureId != null) {
                ...
                result = pictureRepository.update(picture, queryWrapper);
            } else {
                // 新增操作
     ...
     */
    @Override
    public Boolean editPicture(PictureEditRequest pictureUpdateRequest, User user) {
        // 校验参数
        ThrowUtils.throwIf(pictureUpdateRequest == null, ErrorCode.PARAMS_ERROR);
        // 判断照片是否存在
        Picture picture = pictureRepository.getById(pictureUpdateRequest.getId());
        ...
        boolean result = pictureRepository.update(picture, updateWrapper);
        return result;
    }
    ...
    public List<PictureVO> searchPictureByColor(SearchPictureByColorRequest searchPictureByColorRequest, User loginUser) {
        ...
        List<Picture> pictureList = pictureRepository.lambdaQuery().eq(Picture::getSpaceId, spaceId)
    ...
    public void editPictureByBatch(PictureEditByBatchRequest pictureEditByBatchRequest, User loginUser) {
        ...
        for (int i = 0; i < pictureList.size(); i += batchSize) {
            ...
            CompletableFuture<Void> future = CompletableFuture.runAsync(() -> {
                ...
                // 批量更新
                boolean update = pictureRepository.updateBatchById(batchPictures);
    ...
    public CreateOutPaintingTaskResponse createPictureOutPaintingTask(CreatePictureOutPaintingTaskRequest createPictureOutPaintingTaskRequest, User loginUser) {
        // 获取图片信息
        Picture picture = pictureRepository.getById(createPictureOutPaintingTaskRequest.getPictureId());
