...
import com.zzx.zzxpicture.infrastructure.api.imagesearch.ImageSearchApiFacade;
...
import com.zzx.zzxpicture.interfaces.vo.picture.PictureTagCategory;
...
public class PictureController {
    ...
    public BaseResponse<Boolean> deletePicture(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        Boolean result = pictureApplicationService.deletePicture(deleteRequest.getId(), request);
    ...
    public BaseResponse<Boolean> updatePicture(@RequestBody PictureUpdateRequest pictureUpdateRequest, HttpServletRequest request) {
        Boolean result = pictureApplicationService.updatePicture(pictureUpdateRequest, request);
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Boolean> editPicture(@RequestBody PictureEditRequest pictureEditRequest, HttpServletRequest request) {
        Boolean result = pictureApplicationService.editPicture(pictureEditRequest, request);
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Page<Picture>> listPictureByPage(@RequestBody PictureQueryRequest pictureQueryRequest) {
        ...
        Page<Picture> pictureList = pictureApplicationService.page(new Page<>(current, size), pictureApplicationService.getQueryWrapper(pictureQueryRequest));
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPage(@RequestBody PictureQueryRequest pictureQueryRequest, HttpServletRequest request) {
        ...
        // 分页查询
        Page<PictureVO> pictureVOList = pictureApplicationService.getPictureVOPage(current, size, pictureQueryRequest, request);
    ...
    public BaseResponse<Boolean> doPictureReview(@RequestBody PictureReviewRequest pictureReviewRequest, HttpServletRequest request) {
        ...
        // 审核照片
        Boolean result = pictureApplicationService.doPictureReview(pictureReviewRequest, request);
        // 返回
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<List<PictureVO>> searchPictureByColor(@RequestBody SearchPictureByColorRequest searchPictureByColorRequest,
        ...
        List<PictureVO> imageSearchResults = pictureApplicationService.searchPictureByColor(searchPictureByColorRequest, loginUser);
        return ResultUtils.success(imageSearchResults);
    }
    ...
    public BaseResponse<GetOutPaintingTaskResponse> getPictureOutPaintingTask(String taskId){
        ...
        GetOutPaintingTaskResponse response = pictureApplicationService.getPictureOutPaintingTask(taskId);
        return ResultUtils.success(response);
    }
