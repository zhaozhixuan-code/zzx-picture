package com.zzx.zzxpicture.shared.websocket;
...
import com.zzx.zzxpicture.shared.websocket.model.PictureEditActionEnum;
...
import com.zzx.zzxpicture.shared.websocket.disruptor.PictureEditEventProducer;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    public void handleEnterEditMessage(PictureEditRequestMessage pictureEditRequestMessage, WebSocketSession session,
        ...
        if (!pictureEditingUsers.containsKey(pictureId)) {
            ...
            User editingUser = userApplicationService.getUserById(userId);
