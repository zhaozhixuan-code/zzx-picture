...
public class SpaceAnalyzeServiceImpl extends ServiceImpl<SpaceMapper, Space>
    ...
    public List<SpaceCategoryAnalyzeResponse> getSpaceCategoryAnalyze(SpaceCategoryAnalyzeRequest spaceCategoryAnalyzeRequest, User loginUser) {
        ...
        queryWrapper.select("category AS category",
                ...
                .groupBy("category");
        // 查询
        List<SpaceCategoryAnalyzeResponse> spaceCategoryAnalyzeList = pictureService.getBaseMapper().selectMaps(queryWrapper).stream()
                .map(result -> {
    ...
    public List<SpaceSizeAnalyzeResponse> getSpaceSizeAnalyze(SpaceSizeAnalyzeRequest spaceSizeAnalyzeRequest, User loginUser) {
        ...
        // 查询数据库
        List<Long> pictureSizeList = pictureService.getSpaceSizeAnalyze(spaceSizeAnalyzeRequest);
